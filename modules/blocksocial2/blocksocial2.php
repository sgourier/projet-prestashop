...
class blocksocial2 extends Module
{
	public function __construct()
	{
		$this->name = 'blocksocial2';
		$this->tab = 'front_office_features';
		$this->version = '1.0.0';
		$this->author = 'Thibault';
	...
	{
		if (!$this->isCached('blocksocial2.tpl', $this->getCacheId()))
		...
		return $this->display(__FILE__, 'blocksocial2.tpl', $this->getCacheId());
	}
